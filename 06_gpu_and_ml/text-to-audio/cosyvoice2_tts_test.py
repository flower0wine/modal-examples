...
DEFAULT_BASE_URL = "https://flowerwine8023--cosyvoice2-cosyvoice2-0-5b-demo-cosyvoice2-api.modal.run"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Call the deployed CosyVoice2 TTS service with an optional reference voice."
    )
    parser.add_argument(
        "--base-url",
        default=DEFAULT_BASE_URL,
        help="Deployed CosyVoice2 service base URL.",
    )
    parser.add_argument(
        "--prompt",
    ...
    parser.add_argument(
        "--output",
        default="tmp/cosyvoice2-test.wav",
    ...
    parser.add_argument(
        "--no-reference",
        action="store_true",
        help="Use CosyVoice's bundled prompt voice instead of a reference voice.",
    )
    parser.add_argument(
        "--no-text-frontend",
        action="store_true",
